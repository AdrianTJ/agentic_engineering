...
#   4. Every SKILL.md / AGENT.md carries its required frontmatter.
#   5. Every eval spec validates against docs/eval-spec.md (bin/validate-evals.py).
...
python3 bin/validate-evals.py || err "eval spec validation failed"
